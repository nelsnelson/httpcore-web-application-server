...
package org.nelsnelson.org.apache.commons.httpclient;
...
import org.nelsnelson.org.apache.commons.httpclient.cookie.CookiePolicy;
import org.nelsnelson.org.apache.commons.httpclient.cookie.CookieSpec;
...
public class Cookie 
    ...
    implements NameValuePair, Serializable, Comparator 
{
    // ----------------------------------------------------------- Constructors
    ...
    public void setDomain(String domain) {
        if (domain != null) {
            ...
            super.setDomain(domain.toLowerCase());
        }
    }
