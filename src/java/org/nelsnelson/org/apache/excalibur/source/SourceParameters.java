 ...
 */
package org.nelsnelson.org.apache.excalibur.source;
    ...
    implements Serializable, Cloneable
{
     ...
     * 
     */
    private static final long serialVersionUID = 1084860791970883430L;

    /** The parameter names are the keys and the value is a List object */
    private Map<String,List<String>> names = new HashMap<String,List<String>>( 5 );
    ...
    public String getEncodedQueryString() {
        ...
        for (Map.Entry<String, List<String>> entry : this.names.entrySet()) {
            for (String value : entry.getValue()) {
                ...
                if (entry.getValue().size() > 1) result.append('&');
            }
        }
        return (result.length() == 0 ? null : result.toString());
    }
